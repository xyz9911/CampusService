...
urlpatterns = [
    ...
    url(r'^show_student_info$', BuyerViews.show_student_info),
    ...
    url(r'^like_commodity$', CommodityViews.like_commodity),
    url(r'^unlike_commodity$', CommodityViews.unlike_commodity),
    url(r'^rate_commodity$', CommodityViews.rate_commodity),
